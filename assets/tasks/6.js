$(document).ready(function () {
    ...
    // Set links
    $('a.tag, a.switch, .col-sm-auto a.nav-link').attr('href', '/7');
    ...
    $('[href$="7"]').click(function (event) {
        ...
        if ($(this).is('#search-submit')) {
            ...
            ga('send', 'event', 'Task #6: Thing of interest on the Future Students (Video) page', 'Searched', search);
        }
        else {
            ...
            ga('send', 'event', 'Task #6: Thing of interest on the Future Students (Video) page', 'Clicked', label);
        ...
        if (window.performance) {
            ...
            ga('send', 'timing', 'Task #6: Thing of interest on the Future Students (Video) page', 'Clicked', timeSincePageLoad);
        }
    })
