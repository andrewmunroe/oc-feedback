$(document).ready(function () {
    ...
    // Set links
    $('a.tag, a.switch, .col-sm-auto a.nav-link').attr('href', '/2');
    ...
    // Listen for clicks on any element that leads to task 2
    $('[href$="2"]').click(function (event) {
        ...
        if ($(this).is('#search-submit')) {
            ...
            ga('send', 'event', 'Task #1: Find info about program', 'Searched', search);
        }
        else {
            ...
            ga('send', 'event', 'Task #1: Find info about program', 'Clicked', label);
        ...
        if (window.performance) {
            ...
            ga('send', 'timing', 'Task #1: Find info about program', 'Clicked', timeSincePageLoad);
        }
    })
