$(document).ready(function () {
    ...
    // Set links
    $('a.tag, a.switch, .col-sm-auto a.nav-link').attr('href', '/8');
    ...
    $('[href$="8"]').click(function (event) {
        ...
        if ($(this).is('#search-submit')) {
            ...
            ga('send', 'event', 'Task #7: Click the most interesting stat on the Future Students (Video) page', 'Searched', search);
        }
        else {
            ...
            ga('send', 'event', 'Task #7: Click the most interesting stat on the Future Students (Video) page', 'Clicked', label);
        ...
        if (window.performance) {
            ...
            ga('send', 'timing', 'Task #7: Click the most interesting stat on the Future Students (Video) page', 'Clicked', timeSincePageLoad);
        }
    })
